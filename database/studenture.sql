CREATE DATABASE  IF NOT EXISTS `studentuure` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `studentuure`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: studentuure
-- ------------------------------------------------------
...
CREATE TABLE `milestone_result` (
                                    ...
                                    KEY `term_id` (`term_id`),
                                    CONSTRAINT `milestone_result_ibfk_1` FOREIGN KEY (`term_id`) REFERENCES `subjectterm` (`id`)
...
INSERT INTO `milestone_result` VALUES (1,'TEST',100,20,NULL),(7,'WORKSHOP',20,25,NULL),(8,'TEST',20,15,NULL),(12,'EXAM',50,0,NULL),(13,'TEST',20,0,NULL);
...
-- Dump completed on 2022-12-25 11:57:41
...
CREATE TABLE `recordcard` (
                              ...
                              CONSTRAINT `subjectterm` FOREIGN KEY (`recordCard_id`) REFERENCES `subjectterm` (`id`)
...
INSERT INTO `subject` VALUES (2,'Algoritmizace','Phd.Jozef Novak',100,'vedieť algoritmy','BC','CZ','zakladne algoritmy as Sort,Searche'),(5,'Matematika','Phd.Jozef Novak',20,'','BC','CZ',''),(6,'Základy frontendu','Phd.Jozef Novak',20,'React','BC','CZ','React');
...
CREATE TABLE `subjectterm_milestones` (
                                          ...
                                          CONSTRAINT `subjectterm_id` FOREIGN KEY (`subjectterm_milestones_id`) REFERENCES `subjectterm` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subjectterm` (
                               ...
                               `subject_result` int DEFAULT NULL,
                               `milestone_name` varchar(20) DEFAULT NULL,
                               PRIMARY KEY (`id`),
                               UNIQUE KEY `subjectTerm_id_uindex` (`id`),
                               CONSTRAINT `milestone_id` FOREIGN KEY (`id`) REFERENCES `milestone_result` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-12-25 11:57:42
